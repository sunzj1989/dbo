    ...
    $(function() {
        ...
        index_tabs = $('#index_tabs').tabs({
 		...
 		layout_west_tree = $('#layout_west_tree').tree({
            url : '${path }/book/tree?book_code='+$('#book_code').val(),
            parentField : 'pid',
            lines : true,
...
<body>
    ...
    <div id="index_layout">
        <div data-options="region:'north',border:false" style=" overflow: hidden; height:80px;">
            <div>
            	<h1 align="center" style="font-size:25px;margin-top:10px;margin-bottom:0px;">知识库管理系统</h1>
                <span style="float: right; padding-right: 20px; margin-top: 0px; color: #333">欢迎 <b></b>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="logout()" class="easyui-linkbutton" plain="true" icon="icon-clear">安全退出</a></span>
        ...
        <div data-options="region:'west',split:true" title="菜单" style="width: 160px; overflow: hidden;overflow-y:auto; padding:0px">
            <div class="well well-small" style="padding: 5px 5px 5px 5px;">
                ...
                <input type="hidden" id="book_code" value="<%=request.getParameter("book_code")%>" />
            </div>
        </div>
